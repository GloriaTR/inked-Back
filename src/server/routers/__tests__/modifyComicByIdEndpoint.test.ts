...
describe("Given a PATCH '/comics/:id' endpoint", () => {
  describe("When it receives a request with id comicIdMock and 'Maus' comic", () => {
    test("Then it should respond with status code 200 and the comic 'Maus' modified", async () => {
